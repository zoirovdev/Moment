  ...
  return (
    <div className="flex justify-center mt-[30px]">
      {user?.data ? <div className="w-[680px] h-[300px] border rounded-[20px] 
        border-[#ced4da] dark:border-[#212529]
	...
	<div className="flex flex-col justify-center items-center pl-[30px] gap-4">
	  ...
	  <div>
		...
		border border-[#ced5da] dark:border-[#212529] cursor-pointer hover:bg-[#08CB00] 
	...
	<div className="w-[60%] space-y-2">
	  <div className="flex justify-end">
	    <button className="flex flex-row gap-2 justify-center items-center
	      border border-[#ced4da] dark:border-[#212529] hover:border-[#d62828] rounded-[20px] 
	  ...
	  <div className="flex flex-col w-[100%] border border-[#ced4da] dark:border-[#212529]
	    p-4 rounded-[20px] tracking-widest">
	    <div className="flex flex-row justify-between border-b border-[#ced4da] dark:border-[#212529] p-2">
