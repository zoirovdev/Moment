...
const View = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="w-[700px] mt-[50px] space-y-[20px]">
        <p className="text-[#000000] dark:text-[#ffffff] text-2xl">Reading a note</p>
	<div className="flex flex-row justify-between ">
	  <Link to="/" className="flex flex-row  text-[#000000] dark:text-[#ffffff] 
	    hover:bg-[#adb5bd] dark:hover:bg-[#000000] px-2 py-1 gap-2 rounded-[20px]">
	    <ArrowLeft className=""/>
